...
struct ContentView: View {
    ...
    @State private var currentFilter: CIFilter = CIFilter.sepiaTone() // conform to CIFilter so that currentFilter does not conform to CISepiaTone but just to CIFilter
    ...
    var body: some View {
        NavigationView {
            VStack {
                ...
                HStack {
                    Text("Radius")
                    Slider(value: $filterRadius, in: 100...500)
